 ...
 */
final class Version20221017173009 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE notification DROP user_id, DROP hour');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE notification ADD user_id INT DEFAULT NULL, ADD hour TIME DEFAULT NULL');
